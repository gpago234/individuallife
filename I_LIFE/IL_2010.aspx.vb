...
Partial Class I_LIFE_IL_2010
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not (Page.IsPostBack) Then
            ...
            Call Proc_Populate_Box("IL_CODE_LIST", "003", Me.cboBranch)
    ...
    Protected Sub Proc_Populate_Box(ByVal pvCODE As String, ByVal pvTransType As String, ByVal pvcboList As DropDownList)
        ...
        Select Case UCase(Trim(pvCODE))
            ...
            Case "IL_ASSURED_LIST"
                ...
                'strSQL = strSQL & " AND TBIL_INSRD_MDLE = '" & RTrim("IND") & "'"
                strSQL = strSQL & " AND (TBIL_INSRD_SURNAME LIKE '" & RTrim(Me.txtAssured_Search.Text) & "%'"
                strSQL = strSQL & " OR TBIL_INSRD_FIRSTNAME LIKE '" & RTrim(Me.txtAssured_Search.Text) & "%')"
    ...
    Protected Sub DoProc_Assured_Search()
        If RTrim(Me.txtAssured_Search.Text) <> "" Then
            Call Proc_Populate_Box("IL_ASSURED_LIST", "001", Me.cboAssured)
        End If
    End Sub
    ...
    Private Sub DoSave()
        ...
        Me.txtQuote_Num.Text = "P/2013/09/0000001"
