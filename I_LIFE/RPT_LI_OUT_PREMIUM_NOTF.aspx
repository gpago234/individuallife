<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPT_LI_OUT_PREMIUM_NOTF.aspx.vb" Inherits="I_LIFE_RPT_LI_OUT_PREMIUM_NOTF" %>
...
mso-bidi-language:AR-SA">Print Notice of Outstanding Premium</span></b></td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txtPolicyNo" runat="server" Width="269px" BorderStyle="None"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
